 ...
 * @author saudet
 */
object ISIC2019DetectionTest {
    private val log = LoggerFactory.getLogger(ISIC2019DetectionTest::class.java)
    ...
    fun main(args: Array<String>) {
        ...
        val content: INDArray = loader.asMatrix(File("/run/media/fabien/TOSHIBA/IA/ISIC/2019/HAM10000_images_part_2/ISIC_0029306.jpg"))
