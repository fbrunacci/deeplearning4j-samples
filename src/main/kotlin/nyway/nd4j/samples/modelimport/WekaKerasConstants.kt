...
object WekaKerasConstants {
    var Locations: Map<String, String>? = null
    var Checksums: Map<String, Long>? = null

    init {
        val locations: HashMap<String, String> = HashMap()
        val checksums: HashMap<String, Long> = HashMap()
