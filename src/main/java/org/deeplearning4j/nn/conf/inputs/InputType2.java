 ...
 * See: {@link org.deeplearning4j.nn.conf.ComputationGraphConfiguration.GraphBuilder#setInputTypes(InputType2...)} and
 * {@link org.deeplearning4j.nn.conf.ComputationGraphConfiguration#addPreProcessors(InputType2...)}
 *
 * @author Alex Black
 */
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonTypeInfo(use = JsonTypeInfo.Id.CLASS, include = JsonTypeInfo.As.PROPERTY, property = "@class")
public abstract class InputType2 implements Serializable {
    ...
    public static void setDefaultCNN2DFormat(CNN2DFormat defaultCNN2DFormat) {
        defaultCNN2DFormat = defaultCNN2DFormat;
    }
     ...
     */
    public static InputType2 feedForward(long size) {
        return new InputTypeFeedForward(size, null);
    }

    public static InputType2 feedForward(long size, DataFormat timeDistributedFormat) {
     ...
     */
    public static InputType2 recurrent(long size) {
     ...
     * @return InputTypeRecurrent
     */
    public static InputType2 recurrent(long size, long timeSeriesLength) {
        return new InputTypeRecurrent(size, timeSeriesLength, RNNFormat.NCW);
    }

    public static InputType2 recurrent(long size, RNNFormat format){
        return new InputTypeRecurrent(size, format);
    }

    public static InputType2 recurrent(long size, long timeSeriesLength, RNNFormat format){
     ...
     */
    public static InputType2 convolutional(long height, long width, long depth) {
        return convolutional(height, width, depth, getDefaultCNN2DFormat());
    }

    public static InputType2 convolutional(long height, long width, long depth, CNN2DFormat format){
     ...
     */
    @Deprecated
    public static InputType2 convolutional3D(long depth, long height, long width, long channels) {
     ...
     * @return InputTypeConvolutional3D
     */
    public static InputType2 convolutional3D(Convolution3D.DataFormat dataFormat, long depth, long height, long width, long channels) {
     ...
     */
    public static InputType2 convolutionalFlat(long height, long width, long depth) {
    ...
    public static class InputTypeFeedForward extends InputType2 {
        private long size;
    ...
    @Getter
    @EqualsAndHashCode(callSuper = false)
    public static class InputTypeRecurrent extends InputType2 {
        private long size;
    ...
    @Data
    @EqualsAndHashCode(callSuper = false)
    public static class InputTypeConvolutional extends InputType2 {
        public long height;
        public long width;
...
//        }
    ...
    @Data
    @EqualsAndHashCode(callSuper = false)
    public static class InputTypeConvolutional3D extends InputType2 {
    ...
    @Data
    @EqualsAndHashCode(callSuper = false)
    public static class InputTypeConvolutionalFlat extends InputType2 {
        private long height;
        private long width;
        private long depth;
        ...
        public InputType2 getUnflattenedType() {
            return InputType2.convolutional(height, width, depth);
        }
    ...
    public static InputType2 inferInputType(INDArray inputArray) {
        ...
        switch (inputArray.rank()) {
            case 2:
                return InputType2.feedForward(inputArray.size(1));
            case 3:
                return InputType2.recurrent(inputArray.size(1), (int) inputArray.size(2));
            case 4:
                //Order: [minibatch, channels, height, width] -> [h, w, c]
                return InputType2.convolutional(inputArray.size(2), (int) inputArray.size(3), (int) inputArray.size(1));
            case 5:
                //Order: [minibatch, channels, depth, height, width] -> [d, h, w, c]
                return InputType2.convolutional3D(inputArray.size(2), (int) inputArray.size(3),
    ...
    public static InputType2[] inferInputTypes(INDArray... inputArrays) {
        InputType2[] out = new InputType2[inputArrays.length];
